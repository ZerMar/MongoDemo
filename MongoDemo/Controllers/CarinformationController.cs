...
namespace MongoDemo.Controllers
{
    public class CarinformationController : Controller
    {
        ...
        //Created for testing the Turner connection
        public ActionResult ConnectionTest()
        {
            var carDetails = _dbContext._database.GetCollection("Title").FindAll().ToList();
            TempData["Message"] =  carDetails.FirstOrDefault();
            return View();
